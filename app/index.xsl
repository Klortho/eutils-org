  ...
  <xsl:template match='/'>
    <html xml:lang="en">
      ...
      <body style='margin-left: 10%; margin-right: 10%'>
        ...
        <h2>API Examples</h2>
        <p>
          In the following table, "RESTful URL"s are relative to "http://eutils.org/",
        ...
        <table>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed?term=cat&amp;report=idlist</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed?term=cat&amp;report=full</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/24006159?format=rdf</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/24006159,24006160?format=rdf</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/24006159?report=full</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/24108202/links/pubmed_pubmed_five?report=idlist</td>
            <td>esearch pubmed 24108202 | elink pubmed_pubmed_five</td>
            <td>&#160;</td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/24108202/links/pubmed_pubmed_five?report=full</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/gene/672/links/gene_nuccore?report=full</td>
            <td>esearch gene 672 | elink ids gene_nuccore | efetch</td>
            <td>report=full means "fetch"</td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td>/data/gene/672/links/gene_nuccore?report=gbwithparts</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/gene/672/links/gene_nuccore_refseqgene?report=fasta&amp;format=text</td>
          ...
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/field/journal</td>
            <td>(no equivalent)</td>
            <td>Index data about field "journal", returns first 20 items.</td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/field/journal?page=1&amp;pagesize=1000</td>
            <td>(no equivalent)</td>
            <td>Return first 1000 index values</td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td>/data/pubmed/field/journal?term=Journal+of+the+American</td>
            <td>(no equivalent)</td>
